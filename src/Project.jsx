        ...
        >
          <nav className="navbar  flex flex-row-reverse items-center  justify-between overflow-hidden p-6 mx-auto  md:tracking-wider text-sm   border-white/40">
            <div className="flex justify-between gap-8">
              <Link
                className="duration-200 text-white hover:text-yellow-500"
                to="/about"
              >
                About
              </Link>
          ...
          <div className="mx-8  lg:mx-10 ">
            ...
            <div className="projects-card-wrapper flex justify-center flex-col gap-8 items-center w-full pt-24 ">
              <motion.div
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
                // exit={{ x: 0 }}
              ...
              >
                ...
                <div className="details w-full text-white font-Poppins px-4 py-2 md:px-8 md:py-8 flex flex-col gap-6 relative">
                  ...
                  <div className="project-details text-xs   text-zinc-200 md:text-sm md:leading-6 tracking-wide ">
                    <p>
                      RAWG Clone is a web application built using React.js. This
                      amazing website serves as a hub for all your gaming needs,
                      allowing you to explore and discover information about
                      various video games across different platforms.
                    </p>
                  </div>
                  ...
                  <div className="project-links">
                    <div className="md:mt-6 mb-3 flex justify-end gap-10 items-center">
                      <a
                        href="https://github.com/Nischit17/RAWR"
              ...
              >
                ...
                <div className="details w-full text-white font-Poppins  px-4 py-2 md:px-8 md:py-8 flex flex-col gap-6 relative">
                  ...
                  <div className="project-details text-xs   text-zinc-200 md:text-sm md:leading-6 tracking-wide ">
                    <p>
                      Swiggy Clone is a high-performance food ordering app using
                      Swiggy live API for real-time data. Discover top nearby
                      restaurants and their dishes, sort by delivery time, cost,
                      and ratings for a seamless user experience.
                    </p>
                  </div>
                  ...
                  <div className="project-links">
                    <div className="md:mt-6 mb-3 flex justify-end gap-10 items-center">
                      <a
                        href="https://github.com/Nischit17/React-Class"
                        className="hover:-translate-y-1 transition-all z-[3]"
                        target="_blank"
                        rel="noreferrer"
                        cursor="pointer"
                      ...
                      <a
                        href="https://extraordinary-clafoutis-518839.netlify.app/"
                        className="hover:-translate-y-1 transition-all z-[3]"
                        target="_blank"
                        rel="noreferrer"
                        cursor="pointer"
