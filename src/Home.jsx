...
const Home = () => {
  ...
  return (
    <div className="home bg-black flex flex-col items-center justify-center w-screen h-screen overflow-hidden relative">
      <nav className="nav absolute top-10 mt-28 z-[3] font-medium ">
        <button>
          <a
            href="https://drive.google.com/file/d/1Id20UhSIgvnjTpIEckdZgNA1DmHNoU8x/view?usp=sharing"
            target="_blank"
            rel="noreferrer"
      ...
      <div
        id="blob"
        className="bg-white h-[12vmax] aspect-[1] absolute rounded-[50%]  bg-gradient-to-r from-[#00b4d8] to-[#023e8a] animate-rotate "
      ></div>
      <div
        id="blur"
      ...
      <>
        <motion.div
          ...
          className="name text-white z-[3] font-Satisfy text-[clamp(4rem,10vw,10rem)] md:text-[clamp(6rem,10vw,10rem)] lg:text-[clamp(6rem,10vw,10rem)] whitespace-nowrap p-[0rem_clamp(1rem,2vw,3rem)] rounded-[clamp(0.4rem,0.75vw,1rem)] m-0"
        >
          Nischit D S.
        </motion.div>
        <motion.div
